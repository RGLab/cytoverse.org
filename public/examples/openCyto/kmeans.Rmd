...
gs_add_gating_method(gs
					 ...
					 , gating_args = "centers=8, nstart=5" #arguments passed on to gating function
					 )
...
ggcyto(gs, aes(CD45RA, CD4), subset = "CD3+") + 
	...
	geom_gate("tsub 5", color = "purple", alpha = 0.5) +
	geom_gate("tsub 6", color = "yellow", alpha = 0.5) +
	geom_gate("tsub 7", color = "orange", alpha = 0.5) +
	geom_gate("tsub 8", color = "brown", alpha = 0.5)
```
